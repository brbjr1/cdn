								...
								GetAllCustomTabs(conn, function(taberr, tabsresult)
								{
									...
									else
									{
										...
										j$.each(tabsresult, function(index, tab)
										{
											...
											{
												//tab only
												var ctab = {IsCustomTab:true,CusomObjectId: tab.id,CusomTab:tab,label:tab.label,fullName:tab.fullName,fields:[],OneFieldIsPermissionable:false,isCustom:true,isCustomSetting:false,recordtypes:[],IsPermissionable: false};
												result.push(ctab);
											}
										});
