																																											...
																																											try
																																											{
																																												...
																																												else
																																												{
																																													...
																																													if (zipresults.hasItem(profilepackagename) == true)
																																													{
																																														...
																																														{
																																															for (var i3 = 0; i3 < mydetail.Profile.recordTypeVisibilities.length; i3++)
																																															{
																																																var myrtvis = mydetail.Profile.recordTypeVisibilities[i3];
																																													...
																																													if (PermissionSetQueryResults != undefined)
																																													{
																																														for (var i = 0; i < PermissionSetQueryResults.length; i++)
																																														{
																																															...
																																															if (zipresults.hasItem(permpackagename) == true)
																																															{
																																																...
																																																{
																																																	for (var i3 = 0; i3 < mydetail.PermissionSet.recordTypeVisibilities.length; i3++)
																																																	{
																																																		var myrtvis = mydetail.PermissionSet.recordTypeVisibilities[i3];
