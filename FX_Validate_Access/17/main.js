				...
				j$.each(result.FXObjects,
					function(index, d)
					{
						...
						if (d.TabPermissions && d.TabPermissions.length > 0)
						{
							...
							datatableFXObjectsresult += '<a onclick="ShowObjectModal(&apos;' + d.APIName + '&apos;,&aposTabSettings;&apos;);">' + tabpermresult + '</a>';
						}
						datatableFXObjectsresult += '</td>'
				...
				j$.each(result.FXRelatedObjects,
					function(index, d)
					{
						...
						if (d.TabPermissions && d.TabPermissions.length > 0)
						{
							...
							datatableFXRelatedObjectsresult += '<a onclick="ShowObjectModal(&apos;' + d.APIName + '&apos;,&aposTabSettings;&apos;);">' + tabpermresult + '</a>';
						}
						datatableFXRelatedObjectsresult += '</td>'
