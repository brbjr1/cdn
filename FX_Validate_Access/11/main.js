...
/******************Event Handlers *************************************/
		...
		if (fp != undefined && fp != null)
		{
			...
			j$.each(fp,
				function(index, d)
				{
					...
					datatableFieldPermissionsresult += '<td>' + GetSpanPermission(d.Default, true, d.DefaultGrantedBy, fs, 'Object') + '</td>'
					datatableFieldPermissionsresult += '</tr>';
				});
			datatableFieldPermissionsresult += '</tbody>';
	...
	function ShowObjectModal(sobject, sobjectlabel)
	{
		...
		if (ort && ort.length > 0)
		{
			...
			j$.each(ort,
				function(index, d)
				{
					...
					osresult += '<td>' + GetSpanPermission(d.Assigned, true, d.AssignedGrantedBy, ofs, 'Object') + '</td>'
					osresult += '<td>' + GetSpanPermission(d.Default, true, d.DefaultGrantedBy, ofs, 'Object') + '</td>'
					osresult += '</tr>';
				});
			osresult += '</tbody>';
			osresult += '</table>';
		...
		if (ofp)
		{
			...
			j$.each(ofp,
				function(index, d)
				{
					...
					osresult += '<td>' + d.Label + '</td>';
					osresult += '<td>' + d.Name + '</td>';
					osresult += '<td>' + GetSpanPermission(d.HasRead, d.ReadIsAssignable, d.HasReadGrantedBy, ofs, 'Object') + '</td>'
					osresult += '<td>' + GetSpanPermission(d.HasEdit, d.EditIsAssignable, d.HasEditGrantedBy, ofs, 'Object') + '</td>'
					osresult += '</tr>';
				});
			osresult += '</tbody>';
			osresult += '</table>';
			...
			if (result.FXObjects != undefined)
			{
				...
				j$.each(result.FXObjects,
					function(index, d)
					{
						...
						datatableFXObjectsresult += '<td><a onclick="ShowObjectModal(&apos;' + d.APIName + '&apos;,&apos;' + d.Label + '&apos;);">' + d.Label + '</a></td>';
						datatableFXObjectsresult += '<td><a onclick="ShowObjectModal(&apos;' + d.APIName + '&apos;,&apos;' + d.Label + '&apos;);">' + d.APIName + '</a></td>';
						...
						datatableFXObjectsresult += '<td><a onclick="ShowFieldPermissionsModal(&apos;' + d.APIName + '&apos;,&apos;' + d.Label + '&apos;);">' + GetFieldCount(d.fields, true, false, false) + '</a></td>';
						datatableFXObjectsresult += '<td><a onclick="ShowFieldPermissionsModal(&apos;' + d.APIName + '&apos;,&apos;' + d.Label + '&apos;);">' + GetFieldCount(d.fields, false, true, false) + '</a></td>';
						datatableFXObjectsresult += '<td><a onclick="ShowFieldPermissionsModal(&apos;' + d.APIName + '&apos;,&apos;' + d.Label + '&apos;);">' + GetFieldCount(d.fields, false, false, true) + '</a></td>';
						datatableFXObjectsresult += '<td><a onclick="ShowRecordTypePermissionsModal(&apos;' + d.APIName + '&apos;,&apos;' + d.Label + '&apos;);">' + GetRecordTypeCount(d.recordtypes, true) + '</a></td>';
						datatableFXObjectsresult += '<td><a onclick="ShowRecordTypePermissionsModal(&apos;' + d.APIName + '&apos;,&apos;' + d.Label + '&apos;);">' + GetRecordTypeCount(d.recordtypes, false) + '</a></td>';
						datatableFXObjectsresult += '</tr>';
					});
				datatableFXObjectsresult += '</tbody>';
			...
			if (result.FXRelatedObjects != undefined)
			{
				...
				j$.each(result.FXRelatedObjects,
					function(index, d)
					{
						...
						datatableFXRelatedObjectsresult += '<td><a onclick="ShowObjectModal(&apos;' + d.APIName + '&apos;,&apos;' + d.Label + '&apos;);">' + d.Label + '</a></td>';
						datatableFXRelatedObjectsresult += '<td><a onclick="ShowObjectModal(&apos;' + d.APIName + '&apos;,&apos;' + d.Label + '&apos;);">' + d.APIName + '</a></td>';
						...
						datatableFXRelatedObjectsresult += '<td><a onclick="ShowFieldPermissionsModal(&apos;' + d.APIName + '&apos;,&apos;' + d.Label + '&apos;);">' + GetFieldCount(d.fields, true, false, false) + '</a></td>';
						datatableFXRelatedObjectsresult += '<td><a onclick="ShowFieldPermissionsModal(&apos;' + d.APIName + '&apos;,&apos;' + d.Label + '&apos;);">' + GetFieldCount(d.fields, false, true, false) + '</a></td>';
						datatableFXRelatedObjectsresult += '<td><a onclick="ShowFieldPermissionsModal(&apos;' + d.APIName + '&apos;,&apos;' + d.Label + '&apos;);">' + GetFieldCount(d.fields, false, false, true) + '</a></td>';
						datatableFXRelatedObjectsresult += '<td><a onclick="ShowRecordTypePermissionsModal(&apos;' + d.APIName + '&apos;,&apos;' + d.Label + '&apos;);">' + GetRecordTypeCount(d.recordtypes, true) + '</a></td>';
						datatableFXRelatedObjectsresult += '<td><a onclick="ShowRecordTypePermissionsModal(&apos;' + d.APIName + '&apos;,&apos;' + d.Label + '&apos;);">' + GetRecordTypeCount(d.recordtypes, false) + '</a></td>';
						datatableFXRelatedObjectsresult += '</tr>';
					});
				datatableFXRelatedObjectsresult += '</tbody>';
